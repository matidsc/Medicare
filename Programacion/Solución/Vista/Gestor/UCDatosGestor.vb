...
Public Class UCDatosGestor
    ...
    Public Sub New(informacionGestor As DataTable)
        ...
        lblCed.Text = informacionGestor.Rows(0).Item(0).ToString
        lblNom.Text = informacionGestor.Rows(0).Item(1) & " " & informacionGestor.Rows(0).Item(2) & " " & informacionGestor.Rows(0).Item(3) & " " & informacionGestor.Rows(0).Item(4)
